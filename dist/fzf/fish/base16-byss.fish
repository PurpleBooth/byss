...
set -l color00 '#0c100a'
set -l color01 '#1a1d19'
set -l color02 '#262a24'
set -l color03 '#40463e'
set -l color04 '#697368'
set -l color05 '#879385'
set -l color06 '#a5b5a4'
set -l color07 '#d5e9d5'
set -l color08 '#FF00A0'
set -l color09 '#1BE7FF'
set -l color0A '#F9A03F'
set -l color0B '#F0F757'
