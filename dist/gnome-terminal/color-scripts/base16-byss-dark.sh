...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#010114', '#FF00A0', '#28F6C9', '#F9A03F', '#BA0AFF', '#3B60E4', '#40F99B', '#BDECF5', '#0096C7', '#1BE7FF', '#022C64', '#006AA3', '#48CAE4', '#DAF5FA', '#DDE0E3', '#F7FDFE']"
...
gset string palette "['#010114', '#FF00A0', '#28F6C9', '#F9A03F', '#BA0AFF', '#3B60E4', '#40F99B', '#BDECF5', '#0096C7', '#1BE7FF', '#022C64', '#006AA3', '#48CAE4', '#DAF5FA', '#DDE0E3', '#F7FDFE']"
