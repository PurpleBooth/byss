...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Byss Dark 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-byss-dark-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#010114', '#FF00A0', '#28F6C9', '#F9A03F', '#BA0AFF', '#3B60E4', '#40F99B', '#BDECF5', '#0096C7', '#FF00A0', '#28F6C9', '#F9A03F', '#BA0AFF', '#3B60E4', '#40F99B', '#F7FDFE']"
