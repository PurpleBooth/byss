...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Base 16 Byss Light 256"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="base-16-byss-light-256"
[[ -z "$DCONF" ]] && DCONF=dconf
...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#f7fdfe', '#FF00A0', '#40F99B', '#F9A03F', '#BA0AFF', '#3B60E4', '#28F6C9', '#0077b6', '#48cae4', '#FF00A0', '#40F99B', '#F9A03F', '#BA0AFF', '#3B60E4', '#28F6C9', '#010228']"
