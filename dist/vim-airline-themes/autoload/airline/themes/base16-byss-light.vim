" Base16 Byss Light vim-airline-theme (https://github.com/dawikur/base16-vim-airline-themes)
" For vim-airline (https://github.com/vim-airline/vim-airline)
" By Billie Thompson (http://github.com/PurpleBooth)

let s:scheme_slug = substitute("byss-light", "-", "_", "g")
