...
local base06 = "#023e8a" -- +++
local base07 = "#010228" -- ++++
local base08 = "#FF00A0" -- red
local base09 = "#1BE7FF" -- orange
local base0A = "#F9A03F" -- yellow
local base0B = "#40F99B" -- green
local base0C = "#28F6C9" -- aqua/cyan
local base0D = "#BA0AFF" -- blue
local base0E = "#3B60E4" -- purple
local base0F = "#300704" -- brown
